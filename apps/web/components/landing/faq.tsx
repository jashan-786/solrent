    ...
    return (
        <div className="mb-4">
            <button
                ...
                className="w-full flex items-center justify-between p-6 bg-[#f7f8fa] rounded-2xl transition-all duration-200 hover:bg-[#f0f1f3]"
            >
                <span className="text-left font-bold text-[#1a1c1e] text-lg">
                    {question}
                </span>
                <ChevronDown
                    className={`w-5 h-5 text-[#1a1c1e] transition-transform duration-300 ${isOpen ? 'rotate-180' : ''}`}
                />
            </button>
            ...
            >
                <div className="p-6 text-[#4a4d52] leading-relaxed text-md">
                    {answer}
                </div>
            </div>
        </div>
    ...
    return (
        <div className="max-w-3xl mx-auto px-4 py-16 font-sans">
            <div className="text-center mb-12">
                <h2 className="text-4xl font-bold text-[#1a1c1e] mb-4">
                    Common Questions
                </h2>
                <p className="text-[#63676e] text-lg">
