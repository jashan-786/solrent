...
export function PaymentStats() {
    return (
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card className="rounded-3xl border-none bg-primary-950 text-white shadow-xl overflow-hidden relative">
                ...
                <CardContent className="p-8 space-y-4">
                    ...
                    <div className="space-y-1">
                        <h2 className="text-4xl  text-white font-black italic tracking-tighter">84,200 <span className="text-lg font-bold text-secondary-500">USDC</span></h2>
            ...
            <StatCard title="Pending Settlements" value="12,400" unit="PYUSD" icon={<Clock className="h-5 w-5" />} color="orange" />
            <StatCard title="Failed Transfers" value="3" unit="TXS" icon={<AlertCircle className="h-5 w-5" />} color="red" />
        </div>
    );
}
