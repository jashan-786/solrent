    ...
    return (
        <div className="bg-brand-navy rounded-2xl p-4 flex flex-col gap-4 shadow-xl border border-slate-800">
            ...
            <div className="relative aspect-square rounded-xl overflow-hidden bg-linear-to-br from-slate-800 to-brand-navy border border-slate-700/50">
                ...
                <span className="absolute top-3 right-3 bg-solrent-emerald/20 text-solrent-emerald text-[9px] font-bold px-2 py-1 rounded border border-solrent-emerald/30 uppercase tracking-tighter">
            ...
            <div className="flex justify-between items-center pt-2 border-t border-slate-800 mt-auto">
                <a href="#" className="flex items-center gap-1.5 text-solrent-emerald text-[11px] font-bold hover:underline">
